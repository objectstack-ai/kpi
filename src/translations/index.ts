...
export const KpiTranslationBundle = defineTranslationBundle({
  en: {
    objects: {
      kpi_indicator: { label: 'Indicator', pluralLabel: 'Indicators', fields: { code: { label: 'Code' }, name: { label: 'Name' }, category: { label: 'Category' }, owner_unit: { label: 'Owning Unit' }, scoring_method: { label: 'Scoring Method' }, status: { label: 'Status' } } },
