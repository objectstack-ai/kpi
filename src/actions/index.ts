...
export const SheetRejectAction = defineAction({
  ...
  type: 'script',
  variant: 'danger',
  params: [{ name: 'reason', type: 'textarea', label: '驳回原因(必填)', required: true }],
...
export const CheckDisputeAction = defineAction({
  ...
  type: 'script',
  variant: 'danger',
  params: [{ name: 'comment', type: 'textarea', label: '争议内容(必填)', required: true }],
...
export const AdjustmentRejectAction = defineAction({
  ...
  type: 'script',
  variant: 'danger',
  params: [{ name: 'decision_reason', type: 'textarea', label: '否决原因(必填)', required: true }],
...
export const DisputeAcceptAction = defineAction({
  ...
  type: 'script',
  params: [{ name: 'resolution', type: 'textarea', label: '处理结论(必填)', required: true }],
